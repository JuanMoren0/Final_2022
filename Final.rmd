...
At a glace we can see that it's hard to tell but using fisher's exact test and looking at the confidence interval results, its best for females to take the vaccine as it has a slighter chance of not catching covid.  
...
Surprisingly when looking at all the data we can see that the LGBTQ community should not takw the vaccine as it will make them most likely to contract covid, then those whp have taken the placebo.
...
Without a surprise people who do drugs should not take the vaccine as it incresses the chances of contracting covid greatly, then if they were to not take the vaccine.
